<?PHP
	...
	$consulta_procesos = "SELECT * FROM v_procesos_activos WHERE departamento = 'Evaluación y Gestión de la Calidad'
		and	UPPER(nombre) in(UPPER('Auditoria Interna'), UPPER('Medición, análisis y mejora'), 
